...
#     mywad.sprites[0].columnoffsets[0].should eq 0x1D0
#     mywad.sprites[0].columnoffsets[1].should eq 0x1D7
#     mywad.sprites[0].columnoffsets[-1].should eq 0x1FEA

#     mywad.sprites[-1].name.should eq "FCANC0"
#     mywad.sprites[-1].width.should eq 0x24
#     mywad.sprites[-1].height.should eq 0x33
#     mywad.sprites[-1].columnoffsets[0].should eq 0x98
#     mywad.sprites[-1].columnoffsets[1].should eq 0xAE
