...
# Uses a dummy module to make methods show up seperatly in docs
...
module RaylibAdditions
  ...
  class WAD
    ...
    # ```
    def get_texture(name : String, palette : Playpal::Palette) : R::Image
      # For actual *get_texture* definition go to line #8
    end
  end
  ...
  class WAD::Graphic
    ...
    # ```
    def to_tex(palette : Playpal::Palette) : R::Image
      # For actual *to_tex* definition go to line #45
    end
    ...
    # ```
    def get_color(x : Int, y : Int) : R::Color
      # For actual *get_color* definition go to line #58
    end
  end
  ...
  class WAD::Flat
    ...
    # ```
    def to_tex(palette : Playpal::Palette) : R::Image
      # For actual *to_tex* definition go to line #73
    end
    ...
    # ```
    def get_color(x : Int, y : Int) : R::Color
      # For actual *get_color* definition go to line #85
    end
  end
end