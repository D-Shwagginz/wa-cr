...
describe WAD::Graphic do
  it "should properly set the graphics" do
    ...
    (texturenamesstart == mywad.graphics.keys[0...texturenamesstart.size]).should be_true

    texturenamesend = [
      "RP1_1", "RP1_2", *("RP2_1".."RP2_4"), *("SW2_1".."SW2_8"), "DUCT1", "PS15A0", "PS18A0", "SKY2", "SKY3",
    ]

    (texturenamesend == mywad.graphics.keys[-(texturenamesend.size)..-1]).should be_true
  end
end
